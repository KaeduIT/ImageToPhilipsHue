function getConfig() {
	...
	var apiUrl 		= "http://" + bridgeIpAddress + "/api/KaeduITUser/config";
	...
	alert('200');
	  ...
	  var respDiv = document.getElementById("resp");
          respDiv.innerHTML = "getting config";
	  
	  
	  if(response !== null) {
	    respDiv.innerHTML = "got Config";
	    respDiv.innerHTML += xmlhttp.response;
	  }
	  else {
	    respDiv.innerHTML = "Error getting config";
	    respDiv.innerHTML += xmlhttp.response;
	  }
	}
	else {
